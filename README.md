...
<!-- Badges organizados com flexbox -->
<div style="display: flex; justify-content: center; align-items: center; gap: 30px;">
  ...
  <div style="display: flex; justify-content: center; align-items: center;">
    <a href="https://credentials.databricks.com/0404ebcc-9730-44d5-a1ac-9dd320310962#acc.FBiQvEC8" target="_blank">
      <img src="https://api.accredible.com/v1/frontend/credential_website_embed_image/badge/137785572" alt="AWS Databricks Platform Architect Badge" width="100" height="100" style="margin-top: 5px;">
    </a>
  </div>
